...
export default class DinoGame extends GameRunner {
  ...
  endGame() {
    ...
    this.paintText(
      'G A M E  O V E R',
      this.width / 2,
      this.height / 2 - iconSprite.h / 2 - gameoverButtonHeight + padding,
      {
        font: 'pressStart2p',
        size: '12px',
        align: 'center',
    ...
    this.paintText('PLAY AGAIN', this.width / 2, this.height / 2 + iconSprite.h / 2 + padding, {
      font: 'pressStart2p',
      size: '10px',
      align: 'center',
      baseline: 'middle',
    ...
    // 'SAVE SCORE' TEXT
    this.paintText('SAVE SCORE', this.width / 2 + iconSprite.w, this.height - iconSprite.h - padding / 2, {
      font: 'pressStart2p',
      size: '10px',
      align: 'center',
      baseline: 'middle',
