...
export default class DinoGame extends GameRunner {
  ...
  endGame() {
    ...
    // Draw 'save score' button
    this.canvasCtx.fillStyle = '#000000'
    this.canvasCtx.fillRect(saveButtonX - padding, saveButtonY, saveButtonWidth, saveButtonHeight)
    ...
    this.canvasCtx.fillStyle = '#000000'
    this.canvasCtx.fillRect(saveButtonX / 4 + paddingOne + padding / 2, saveButtonY, saveButtonWidth, saveButtonHeight)
    ...
    // Draw 'go back' button
    const goBackButtonX = this.width / 2 - saveButtonWidth / 2
    const goBackButtonY = this.height - iconSprite.h - paddingOne + saveButtonHeight + padding
    this.canvasCtx.fillStyle = '#000000'
    this.canvasCtx.fillRect(goBackButtonX, goBackButtonY, saveButtonWidth, saveButtonHeight)
    this.paintText('EXIT GAME', this.width / 2, this.height - iconSprite.h + padding * 2, {
      font: 'pressStart2p',
      size: '10px',
      align: 'center',
      baseline: 'middle',
