...
export default class DinoGame extends GameRunner {
  ...
  endGame() {
    ...
    this.canvasCtx.fillRect(this.width / 2 - gameoverButtonWidth / 2, this.height / 2 - iconSprite.h / 2 - gameoverButtonHeight, gameoverButtonWidth, gameoverButtonHeight)
    // GAME OVER TEXT
    this.paintText(
      'G A M E  O V E R',
      this.width / 2,
    ...
    // 'PLAY AGAIN' button
    this.canvasCtx.fillStyle = '#000000'
    this.canvasCtx.fillRect(this.width / 2 - smallButtonWidth / 2, this.height / 2 + iconSprite.h / 2, smallButtonWidth, smallButtonHeight)
    // Paint PLAY AGAIN text
    // this.paintText('PLAY AGAIN', this.width / 3 - iconSprite.w / 5, this.height - iconSprite.h - padding / 2
    ...
    // 'SAVE SCORE' button
    this.canvasCtx.fillStyle = '#000000'
    this.canvasCtx.fillRect(this.width / 2 - iconSprite.w / 2 - smallButtonWidth, this.height / 2 - smallButtonHeight / 2, smallButtonWidth, smallButtonHeight)
    // 'SAVE SCORE' TEXT
  ...
  handleCanvasClick(event) {
    ...
    const iconSprite = sprites.replayIcon
    const paddingOne = isMobile ? 15 : 20
    const saveButtonWidth = isMobile ? 100 : 110
    const saveButtonHeight = isMobile ? 20 : 25
    ...
    if (
      x >= goBackButtonX &&
      x <= goBackButtonX + saveButtonWidth &&
      y >= goBackButtonY &&
      y <= goBackButtonY + saveButtonHeight
    ) {
